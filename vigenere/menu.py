...
def menu():
	...
	if menu is "1":
		...
		chave = input("Digite a chave de criptografia:  \b").replace(" ","").upper()
		chaveador = "1"
		vigenere.cripto(frase, chave, chaveador)
	elif menu is "2":
		frase = input("Digite a frase a ser descriptografada:  \b").replace(" ","").upper()
		chave = input("Digite a chave de decriptografia:  \b").replace(" ","").upper()
		chaveador = "2"
		vigenere.cripto(frase, chave, chaveador)
	elif menu is "3":
		ajuda()
